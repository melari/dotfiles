...
-- Opacity overrides, so these apps stay fully opaque if global opacity is lowered
...
-- hyprland-run: dock it to the bottom-left. Must stay last so its `move`
-- isn't overridden by an earlier rule.
hl.window_rule({
